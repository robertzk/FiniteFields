...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$simplify!', '$each', '$==', '$value', '$-', '$each_with_index', '$+', '$%', '$*', '$**', '$map!', '$>', '$length', '$[]', '$shift', '$degree', '$prime', '$join', '$compact', '$map', '$===', '$to_string', '$is_a?', '$[]=', '$new', '$class', '$raise', '$<=', '$count', '$select', '$coefficients', '$max', '$concat', '$-@', '$nil?', '$puts', '$construct_irreducible_polynomial', '$to_s', '$exponent', '$polynomial', '$open', '$default_poly', '$gsub', '$all_elements', '$<<', '$close', '$protected', '$to_a', '$/', '$floor', '$reverse', '$is_irreducible', '$finite_field', '$>=', '$inverse_in_prime_field', '$coefficients=', '$sanity_check', '$to_ffp', '$inverse', '$<', '$dup', '$send', '$integer_wrap', '$method_defined?', '$alias_method']);
  ;
  (function($base, $super) {
...
if (c == null) c = nil;if (i == null) i = nil;
  ...
  (function($base, $super) {
    ...
    def.polynomial = def.all_elements = def.prime = nil;
    ...
    def.$initialize = function(p, n, poly) {
      ...
      if (($a = poly['$nil?']()) !== false && $a !== nil) {
        ...
        if (($a = self.polynomial) === false || $a === nil) {
          self.$raise($scope.Exception.$new("No irreducible polynomial of degree " + (n) + " mod " + (p) + " found!"))};
    ...
    def.$to_s = function() {
      ...
      return ((((("Finite Field of degree ") + (deg)) + " represented by F_") + (self.$degree())) + "[x] / (")['$+']("" + (self.$polynomial().$to_s(true)) + ")");
    };

    def.$multiplication_table = function(f) {
      var $a, TMP_13, $b, TMP_14, $c, self = this, just_body = nil, mt_string = nil, output = nil, ffp_string = nil, finite_field_string = nil;
      if (f == null) {
      ...
      output = output['$+']("      <h2 style=\"margin: 0\">Multiplication table for\n      F<sub>" + (self.$degree()) + "</sub> embedded in F<sub>" + (self.$prime()) + "</sub>[X] /\n      (" + (self.$polynomial().$to_string(true).$gsub(/^([0-9]+)/, "<sup>\\1</sup>")) + ")</h2>\n      <h3 style=\"margin: 0\">This was generated in Ruby using\n      <pre style=\"display: inline-block\">\n" + (finite_field_string) + ".multiplication_table" + (mt_string) + "</pre></h3>\n");
      output = output['$+']("<table><thead><tr><td> * </td>");
      ($a = ($b = self.$all_elements()).$each, $a._p = (TMP_13 = function(el) {var self = TMP_13._s || this;if (el == null) el = nil;
        return output = output['$+']("<td>" + (el.$to_string(true)) + "</td>")}, TMP_13._s = self, TMP_13), $a).call($b);
      output = output['$+']("</tr></thead><tbody>\n");
      ($a = ($c = self.$all_elements()).$each, $a._p = (TMP_14 = function(el) {var self = TMP_14._s || this, TMP_15, $a, $b;if (el == null) el = nil;
        output = output['$+']("<tr><td>" + (el.$to_string(true)) + "</td>");
        ($a = ($b = self.$all_elements()).$each, $a._p = (TMP_15 = function(el2) {var self = TMP_15._s || this;if (el2 == null) el2 = nil;
          return output = output['$+']("<td>" + ((el['$*'](el2)).$to_string(true)) + "</td>")}, TMP_15._s = self, TMP_15), $a).call($b);
    ...
    def.$all_elements = function() {
      var $a, TMP_16, $b, self = this, list = nil, coeffs_list = nil;
      if (($a = self.all_elements) !== false && $a !== nil) {
        return self.all_elements};
      list = [];
      coeffs_list = ($range(1, (self.$degree()['$-'](1)), false)).$to_a();
      ($a = ($b = coeffs_list).$each, $a._p = (TMP_16 = function(coeff_encoding) {var self = TMP_16._s || this, $a, $b, $c, coeffs = nil;if (coeff_encoding == null) coeff_encoding = nil;
        coeffs = [];
        ...
        return list['$<<'](($a = $scope.FiniteFieldElement).$new.apply($a, [self].concat(coeffs.$reverse())));}, TMP_16._s = self, TMP_16), $a).call($b);
      return self.all_elements = list;
    };

    return (def.$construct_irreducible_polynomial = function() {try {

      var TMP_17, $a, $b, self = this;
      ($a = ($b = ($range(1, (self.prime['$-'](1)), false))).$each, $a._p = (TMP_17 = function(a_n) {var self = TMP_17._s || this, TMP_18, $a, $b, coeffs_list = nil;
        if (self.prime == null) self.prime = nil;
        if (self.exponent == null) self.exponent = nil;
if (a_n == null) a_n = nil;
        coeffs_list = ($range(0, (self.prime['$**'](self.exponent)['$-'](1)), false)).$to_a().$reverse();
        return ($a = ($b = coeffs_list).$each, $a._p = (TMP_18 = function(coeff_encoding) {var self = TMP_18._s || this, $a, $b, $c, coeffs = nil, poly = nil;
          if (self.prime == null) self.prime = nil;
          if (self.exponent == null) self.exponent = nil;
if (coeff_encoding == null) coeff_encoding = nil;
          ...
          if (($b = poly.$is_irreducible()) !== false && $b !== nil) {
            ...
            return nil
          };}, TMP_18._s = self, TMP_18), $a).call($b);}, TMP_17._s = self, TMP_17), $a).call($b);
      return nil;
      } catch ($returner) { if ($returner === $opal.returner) { return $returner.$v } throw $returner; }
    }, nil);
  })(self, null);
  (function($base, $super) {
    ...
    var def = FiniteFieldElement._proto, $scope = FiniteFieldElement._scope, TMP_19, TMP_20, TMP_25;
    def.inverse_of_leading_coefficient = nil;
    self.$attr_accessor("finite_field", "coefficients");

    def.$initialize = TMP_19 = function(_finite_field, _coefficients) {
      var $a, $b, self = this, $iter = TMP_19._p, $yield = $iter || nil;
      _coefficients = $slice.call(arguments, 1);
      TMP_19._p = null;
      ...
      self.coefficients = _coefficients;
      return $opal.find_super_dispatcher(self, 'initialize', TMP_19, null).apply(self, [self.$finite_field().$prime()].concat(self.$coefficients()));
    };

    def['$simplify!'] = TMP_20 = function() {var $zuper = $slice.call(arguments, 0);
      var $a, TMP_21, $b, TMP_22, $c, self = this, $iter = TMP_20._p, $yield = $iter || nil, coeffs = nil, deg_diff = nil, new_coeffs = nil;
      TMP_20._p = null;
      $opal.find_super_dispatcher(self, 'simplify!', TMP_20, $iter).apply(self, $zuper);
      if (self.$degree()['$>='](self.$finite_field().$exponent())) {
        ...
        coeffs = ($a = ($b = coeffs).$map, $a._p = (TMP_21 = function(c) {var self = TMP_21._s || this;
          if (self.inverse_of_leading_coefficient == null) self.inverse_of_leading_coefficient = nil;
if (c == null) c = nil;
          return c['$*'](self.inverse_of_leading_coefficient)['$%'](self.$finite_field().$prime())}, TMP_21._s = self, TMP_21), $a).call($b);
        ...
        ($a = ($c = ($range(0, deg_diff, false))).$each, $a._p = (TMP_22 = function(i) {var self = TMP_22._s || this, $a, TMP_23, $b, extra_coeffs = nil;if (i == null) i = nil;
          ...
          return new_coeffs = ($a = ($b = new_coeffs.$each_with_index()).$map, $a._p = (TMP_23 = function(coeff, index) {var self = TMP_23._s || this;if (coeff == null) coeff = nil;if (index == null) index = nil;
            return coeff['$+'](extra_coeffs['$[]'](index)['$*'](self.$coefficients()['$[]'](i)))}, TMP_23._s = self, TMP_23), $a).call($b);}, TMP_22._s = self, TMP_22), $a).call($c);
    ...
    def.$inverse = function() {try {
      ...
      var TMP_24, $a, $b, self = this, coeffs_list = nil;
      if (self.$degree()['$=='](0)) {
        return $scope.FiniteField.$inverse_in_prime_field(self.$coefficients()['$[]'](0), self.$finite_field().$prime())};
      coeffs_list = ($range(0, (self.$finite_field().$degree()['$-'](1)), false)).$to_a().$reverse();
      ($a = ($b = coeffs_list).$each, $a._p = (TMP_24 = function(coeff_encoding) {var self = TMP_24._s || this, $a, $b, $c, coeffs = nil, poly = nil;if (coeff_encoding == null) coeff_encoding = nil;
        coeffs = [];
        while (($b = ($c = coeff_encoding['$=='](0), ($c === nil || $c === false))) !== false && $b !== nil) {
    ...
    def.$to_s = TMP_25 = function(raw) {var $zuper = $slice.call(arguments, 0);
      var self = this, $iter = TMP_25._p, $yield = $iter || nil;
      if (raw == null) {
        raw = true
      }
      TMP_25._p = null;
      return $opal.find_super_dispatcher(self, 'to_s', TMP_25, $iter).apply(self, $zuper)['$+'](((function() {if (raw !== false && raw !== nil) {
        return ""
        } else {

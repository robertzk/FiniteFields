...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$simplify!', '$each', '$==', '$value', '$-', '$each_with_index', '$+', '$%', '$*', '$**', '$map!', '$>', '$length', '$[]', '$shift', '$degree', '$prime', '$join', '$compact', '$map', '$===', '$to_string', '$is_a?', '$[]=', '$new', '$class', '$raise', '$<=', '$count', '$select', '$coefficients', '$max', '$concat', '$-@', '$nil?', '$puts', '$construct_irreducible_polynomial', '$to_s', '$exponent', '$polynomial', '$open', '$default_poly', '$gsub', '$lambda', '$call', '$all_elements', '$<<', '$close', '$protected', '$/', '$floor', '$reverse', '$is_irreducible', '$finite_field', '$>=', '$inverse_in_prime_field', '$coefficients=', '$sanity_check', '$to_ffp', '$inverse', '$<', '$dup', '$send', '$integer_wrap', '$method_defined?', '$alias_method']);
  (function($base, $super) {

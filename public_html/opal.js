...
(function($opal) {
  ...
  return (function($base) {
    ...
    def.$enum_for = function(method, args) {
      ...
      return ($a = $scope.Enumerator).$new.apply($a, [self, method].concat(args));
    };
  ...
  return (function($base) {
    ...
    def['$all?'] = TMP_1 = function() {
      ...
      if (block !== nil) {
        ...
        self.$each._p = function(obj) {
          if (arguments.length == 1 && $scope.Opal['$falsy?'](obj)) {
            result = false;
            return $breaker;
          }
        }
    ...
    def['$any?'] = TMP_2 = function() {
      ...
      if (block !== nil) {
        ...
        self.$each._p = function(obj) {
          if (arguments.length != 1 || $scope.Opal['$truthy?'](obj)) {
            result = true;
            return $breaker;
          }
        }
    ...
    def.$group_by = TMP_13 = function() {
      var TMP_14, $a, $b, self = this, $iter = TMP_13._p, block = $iter || nil, hash = nil;
      TMP_13._p = null;
      if (block === nil) {
        return self.$enum_for("group_by")};
      hash = ($a = ($b = $scope.Hash).$new, $a._p = (TMP_14 = function(h, k) {var self = TMP_14._s || this;if (h == null) h = nil;if (k == null) k = nil;
    ...
    def.$slice_before = TMP_23 = function(pattern) {
      var $a, TMP_24, $b, self = this, $iter = TMP_23._p, block = $iter || nil;
      TMP_23._p = null;
      ...
      return ($a = ($b = $scope.Enumerator).$new, $a._p = (TMP_24 = function(e) {var self = TMP_24._s || this;if (e == null) e = nil;
        ...
        if (block !== nil) {
          if (pattern === undefined) {
            self.$each._p = function() {
              ...
              if ($scope.Opal['$truthy?'](value) && slice.length > 0) {
                e['$<<'](slice);
                slice = [];
              }
    ...
    def.$sort_by = TMP_25 = function() {
      ...
      return ($a = ($b = ($c = ($d = ($e = ($f = self).$map, $e._p = (TMP_28 = function() {var self = TMP_28._s || this;
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    var def = Enumerator._proto, $scope = Enumerator._scope, TMP_1, TMP_2;
    ...
    def.$each = TMP_2 = function() {
      ...
      if (($a = self.block) !== false && $a !== nil) {
        return $scope.Yielder.$new(self, self.block, block).$call()
        } else {
    ...
    def.$next = function() {
      ...
      if (($a = self.cache['$empty?']()) !== false && $a !== nil) {
        self.$raise($scope.StopIteration, "end of enumeration")};
  ...
  return (function($base, $super) {
    ...
    def['$&'] = function(other) {
      ...
      if (($a = $scope.Array['$==='](other)) !== false && $a !== nil) {
        ...
        other = $scope.Opal.$coerce_to(other, $scope.Array, "to_ary")
      };
    ...
    def.$cycle = TMP_2 = function(n) {
      ...
      if (($a = n === nil) !== false && $a !== nil) {
        ...
        cycles = $scope.Opal.$coerce_to(n, $scope.Integer, "to_int");
        if (($a = $scope.Integer['$==='](cycles)) === false || $a === nil) {
          self.$raise($scope.TypeError, "can't convert " + (n.$class()) + " into Integer (" + (n.$class()) + "#to_int gives " + (cycles.$class()))};
        while (cycles['$>'](0)) {
    ...
    def.$fetch = TMP_8 = function(index, defaults) {
      ...
      self.$raise($scope.IndexError, "Array#fetch");
    ...
    def.$fill = TMP_9 = function(args) {
      ...
      if (($a = right > 2147483648) !== false && $a !== nil) {
        self.$raise($scope.RangeError, "bignum too big to convert into `long'")
      } else if (($a = right >= 536870910) !== false && $a !== nil) {
        self.$raise($scope.ArgumentError, "argument too big")};
    ...
    def.$transpose = function() {
      ...
      ($a = ($b = self).$each, $a._p = (TMP_22 = function(row) {var self = TMP_22._s || this, $a, $b, TMP_23;if (row == null) row = nil;
        if (($a = $scope.Array['$==='](row)) !== false && $a !== nil) {
          ...
          row = $scope.Opal.$coerce_to(row, $scope.Array, "to_ary")
        };
    ...
    def.$chomp = function(separator) {
      ...
      if (($a = separator._isString == null) !== false && $a !== nil) {
        if (($a = separator['$respond_to?']("to_str")) === false || $a === nil) {
          self.$raise($scope.TypeError, "no implicit conversion of " + (separator.$class().$name()) + " into String")};
...
/* Generated by Opal 0.4.4 */
(function($opal) {
  var TMP_4, $a, $b, TMP_6, $c, TMP_8, $d, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2;
  ...
  (function($base, $super) {
    ...
    $opal.defs(self, '$register', TMP_1 = function(name, options) {
      var $a, $b, TMP_2, $c, self = this, $iter = TMP_1._p, block = $iter || nil, names = nil, encoding = nil;
      if (options == null) {
        options = $hash2([], {})
      }
      TMP_1._p = null;
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    var def = Struct._proto, $scope = Struct._scope, TMP_1, TMP_9, TMP_11;
    $opal.defs(self, '$new', TMP_1 = function(name, args) {var $zuper = $slice.call(arguments, 0);
      var $a, TMP_2, $b, $c, self = this, $iter = TMP_1._p, block = $iter || nil;
      args = $slice.call(arguments, 1);
      TMP_1._p = null;
      ...
      if (name['$[]'](0)['$=='](name['$[]'](0).$upcase())) {
        ...
        args.$unshift(name);
        return ($b = ($c = $scope.Class).$new, $b._p = (TMP_2 = function() {var self = TMP_2._s || this, TMP_3, $a, $b, $c;
    ...
    $opal.defs(self, '$define_struct_attribute', function(name) {
      var TMP_4, $a, $b, TMP_5, $c, self = this;
    ...
    $opal.defs(self, '$inherited', function(klass) {
      var TMP_6, $a, $b, self = this, members = nil;
      if (self.members == null) self.members = nil;
    ...
    return (def.$inspect = function() {
      var TMP_16, $a, $b, self = this, result = nil;
      result = "#<struct ";
...
(function($opal) {
  ...
  (function($base, $super) {
    ...
    var def = Native._proto, $scope = Native._scope, TMP_7, TMP_8, TMP_9;
    def['native'] = nil;
    (function($base) {
      ...
      (function($base) {
        ...
        def.$alias_native = function(new$, old, options) {
          ...
          if (($a = old['$end_with?']("=")) !== false && $a !== nil) {
            return ($a = ($b = self).$define_method, $a._p = (TMP_1 = function(value) {var self = TMP_1._s || this;
...
if (value == null) value = nil;
            ...
            return ($a = ($c = self).$define_method, $a._p = (TMP_2 = function(args) {var self = TMP_2._s || this, block, $a, $b, $c;
              if (self['native'] == null) self['native'] = nil;
args = $slice.call(arguments, 0);
            ...
            return ($a = ($d = self).$define_method, $a._p = (TMP_3 = function(args) {var self = TMP_3._s || this, block, $a, $b;
              if (self['native'] == null) self['native'] = nil;
args = $slice.call(arguments, 0);
              block = TMP_3._p || nil, TMP_3._p = null;
              return ($a = ($b = $scope.Native).$call, $a._p = block.$to_proc(), $a).apply($b, [self['native'], old].concat(args))}, TMP_3._s = self, TMP_3), $a).call($d, new$)
          };
        }
      ...
      $opal.defs(self, '$included', function(klass) {
        ...
        return ($a = ($b = klass).$instance_eval, $a._p = (TMP_4 = function() {var self = TMP_4._s || this;
          return self.$extend($scope.Helpers)}, TMP_4._s = self, TMP_4), $a).call($b);
      });
    ...
    (function($base, $super) {
      ...
      var def = Array._proto, $scope = Array._scope, TMP_5, TMP_6;
      def.named = def['native'] = def.get = def.block = def.set = def.length = nil;
      self.$include($scope.Base);
...
/* Generated by Opal 0.4.4 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $gvars = $opal.gvars, $hash2 = $opal.hash2, $module = $opal.module;
